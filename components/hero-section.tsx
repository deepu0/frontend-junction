        ...
        <div className='animate-in fade-in slide-in-from-bottom-4 duration-1000'>
          ...
          <div className='flex flex-col sm:flex-row items-center justify-center gap-4 pb-16'>
            <Link href='/interview-experience' prefetch={false}>
              <button
                type='button'
                className='px-8 py-3.5 rounded-full bg-white/10 hover:bg-white/20 border border-white/10 text-white font-medium transition-all backdrop-blur-sm active:scale-95 duration-200'
              >
                Browse Experiences
              </button>
            </Link>
